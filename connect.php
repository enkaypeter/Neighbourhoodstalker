...
<html>
    <head>
        <title>Neighbourhoodstalker - Connect</title>
    ...
    <body>
         <div class="navbar navbar-default navbar-fixed-top">
            <div class= "container">    
                <a href="connect.php" class="navbar-brand"><span class="link_header">NS!</span></a>
                ...
                <div class="collapse navbar-collapse navHeaderCollapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="connect.php" class="dropdown-toggle" data-toggle = "dropdown">Services<b class="caret"></b></a>
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="laundry.php">Laundrty</a></li>
                            </ul>
                        </li>
                         <li class="dropdown">
         ...
         <div class="container">
            <div class="row">
                <div class="col-md-12 jumbotron mDowm">
