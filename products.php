...
<html>
    <head>
        <title>Neighbourhoodstalker - Products</title>
    ...
    <body>
         <div class="navbar navbar-default navbar-fixed-top">
            <div class= "container">    
                <a href="products.php" class="navbar-brand"><span class="link_header"><p>Products</p></span></a>
                ...
                <div class="collapse navbar-collapse navHeaderCollapse">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a href="products.php" class="dropdown-toggle" data-toggle = "dropdown">Services<b class="caret"></b></a>
